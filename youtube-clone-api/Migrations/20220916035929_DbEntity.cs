        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscribers_Users_SubscribedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VideoOwnerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Videos_Users_VideoOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CommentedVideoId = table.Column<int>(type: "int", nullable: false),
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CommentatorEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Videos_CommentedVideoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CommentedVideoId",
                table: "Comments",
                column: "CommentedVideoId");

            migrationBuilder.CreateIndex(
                name: "IX_Subscribers_SubscribedUserId",
                table: "Subscribers",
                column: "SubscribedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Videos_VideoOwnerId",
                table: "Videos",
                column: "VideoOwnerId");
        }
